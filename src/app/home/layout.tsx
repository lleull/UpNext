        ...
        <div className='w-full flex-col h-screen bg-black flex items-center justify-start'>
            <div className='h-26 pt-10 pl-10 pr-10 bg-white w-full justify-between flex flex-row items-center '>
                ...
                <ul className='flex w-1/2 flex-row items-center pr-36 pl-36 justify-between'>
                    ...
                    <li className='text-blue-800 font-semibold text-2xl hover:text-red-950 cursor-pointer'>Story</li>
                    <li className='text-blue-800 font-semibold text-2xl hover:text-red-950 cursor-pointer'>Contact</li>
                    <li className='text-blue-800 font-semibold text-2xl hover:text-red-950 cursor-pointer'>Account</li>
                </ul>
